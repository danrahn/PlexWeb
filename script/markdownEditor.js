...
let MarkdownEditor = new function()
{
    ...
    this.getToolbar = function(textarea)
    {
        return buildNode("div", { class : "mdToolbar", targetTextarea : textarea.id }).appendChildren(
            ...
            toolbarButton("addSuperscript", "<em>X<sup>2</sup></em>", "Superscript (Ctrl + Shift + ^)", true /*realButton*/),
            toolbarButton("addSubscript", "<em>X<sub>2</sub></em>", "Subscript (Ctrl + Shift + ~)", true /*realButton*/),
